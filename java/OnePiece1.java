...
public class OnePiece1 {
    ...
    static String ChooseName(String _whatToRename, String _defaultName) {
        System.out.println(
                "le nom de votre " + _whatToRename + " est " + _defaultName + " voulez vous le changer ? \n[o/n]");
    ...
    static String ConfirmName(String _whatToRename, String _defaultName) {
        ...
        System.out.println("Vous ne pourrez pas changer le nom de votre " + _whatToRename
                + " durant toute votre aventure. Confirmer le nom : " + _defaultName + "\n[o/n]");
        String _choice = input.nextLine().toLowerCase();
        if (_choice.equals("o")) {
